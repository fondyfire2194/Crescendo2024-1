...
public class VisionSubsystem extends SubsystemBase implements AutoCloseable {
  ...
  private VisionSubsystem(Hardware visionHardware) {
    ...
    m_cameraNotifier.startPeriodic(frc.robot.Constants.GlobalConstants.ROBOT_LOOP_PERIOD);
  }

  public static Hardware initializeHardware() {
    Hardware visionHardware = new Hardware(
      new VisionCamera(
        CameraConstants.CAMERA_A_NAME,
        CameraConstants.CAMERA_A_LOCATION,
        CameraConstants.CAMERA_A_RESOLUTION,
        CameraConstants.CAMERA_A_FOV
      ),
      new VisionCamera(
        CameraConstants.CAMERA_B_NAME,
        CameraConstants.CAMERA_B_LOCATION,
        CameraConstants.CAMERA_B_RESOLUTION,
        CameraConstants.CAMERA_B_FOV
      ),
      new VisionCamera(
        CameraConstants.CAMERA_C_NAME,
        CameraConstants.CAMERA_C_LOCATION,
        CameraConstants.CAMERA_C_RESOLUTION,
        CameraConstants.CAMERA_C_FOV
      )
    );
